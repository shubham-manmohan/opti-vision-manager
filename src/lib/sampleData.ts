import { Customer, Order, InventoryItem } from './store';
...
export const sampleInventory: Omit<InventoryItem, 'id' | 'createdAt' | 'updatedAt'>[] = [
  {
...
export const sampleOrders: Omit<Order, 'id' | 'orderId' | 'createdAt' | 'updatedAt'>[] = [
  {
