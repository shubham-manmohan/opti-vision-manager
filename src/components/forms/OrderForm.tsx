...
import { Order, Customer, useAppStore } from '@/lib/store';
...
export const OrderForm = ({ order, onClose, onSave }: OrderFormProps) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.frameDetails.trim()) newErrors.frameDetails = 'Frame details are required';
    ...
    if (formData.advancePaid < 0) newErrors.advancePaid = 'Advance paid cannot be negative';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value: Order['status']) => handleInputChange('status', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              {selectedCustomer && (
                <div className="p-3 bg-muted/20 rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    <strong>Selected Customer:</strong> {selectedCustomer.name} | {selectedCustomer.phone}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('frameDetails', e.target.value)}
                    placeholder="Brand, Model, Color, Size"
                    className={errors.frameDetails ? 'border-destructive' : ''}
                  />
                  {errors.frameDetails && <p className="text-sm text-destructive">{errors.frameDetails}</p>}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.lensType && <p className="text-sm text-destructive">{errors.lensType}</p>}
                </div>
              </div>
            </div>
